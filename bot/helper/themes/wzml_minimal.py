...
------------------------------------------\n\n"""
    ...
    L_CC =                  '┖ <b>Bʏ : </b>{Tag}\n\n'
    PM_BOT_MSG =            '➲ <b><i>Fɪʟᴇ(s) Hᴀᴠᴇ Bᴇᴇɴ Sᴇɴᴛ Aʙᴏᴠᴇ</i></b>'
    L_BOT_MSG =             '➲ <b><i>Fɪʟᴇ(s) Hᴀᴠᴇ Bᴇᴇɴ Sᴇɴᴛ ᴛᴏ ʙᴏᴛ Pᴍ (Pʀɪᴠᴀᴛᴇ)</i></b>'
    L_LL_MSG =              '➲ <b><i>Fɪʟᴇ(s) Hᴀᴠᴇ Bᴇᴇɴ Sᴇɴᴛ. Aᴄᴄᴇss Vɪᴀ Lɪɴᴋs...</i></b>\n'
    ...
    M_CC =                  '┖ <b>Bʏ : </b>{Tag}\n\n'
    M_BOT_MSG =             '➲ <b><i>Lɪɴᴋ(s) Hᴀᴠᴇ Bᴇᴇɴ Sᴇɴᴛ Tᴏ Bᴏᴛ Pᴍ (Pʀɪᴠᴀᴛᴇ)</i></b>'
    # ----- BUTTONS -------
    ...
    VIEW_LINK =       '🌐 Vɪᴇᴡ Lɪɴᴋ'
    CHECK_PM =        '📥 Vɪᴇᴡ Iɴ Bᴏᴛ Pᴍ'
    CHECK_LL =        '🖇 Vɪᴇᴡ Iɴ Lɪɴᴋs Lᴏɢ'
    ...
    BOT_TASKS = '┠ <b>Tᴀsᴋs :</b> {Tasks}/{Ttask} | <b>ᴀᴠʟ :</b> {Free}\n'
    Cpu = '┠ <b>ᴄᴘᴜ:</b> {cpu}% | '
    ...
    STOP_DUPLICATE = 'Fɪʟᴇ/Fᴏʟᴅᴇʀ Is Aʟʀᴇᴀᴅʏ Aᴠᴀɪʟᴀʙʟᴇ Iɴ Dʀɪᴠᴇ.\nHᴇʀᴇ Aʀᴇ {content} Lɪsᴛ Rᴇsᴜʟᴛs :'
    # ---------------------
    ...
    # LIST ---> gd_list.py
    LIST_SEARCHING = '<b>Sᴇᴀʀᴄʜɪɴɢ Fᴏʀ <i>{NAME}</i></b>'
    LIST_FOUND = '<b>Fᴏᴜɴᴅ {NO} Rᴇsᴜʟᴛ Fᴏʀ <i>{NAME}</i></b>'
    LIST_NOT_FOUND = 'Nᴏ Rᴇsᴜʟᴛ Fᴏᴜɴᴅ Fᴏʀ <i>{NAME}</i>'
    # ---------------------
